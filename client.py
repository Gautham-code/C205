...
def finishingBox():
    ...
    finishingBox = Label(gameWindow, text="Home", font=("Chalkboard SE", 32), width=4, height=4, borderwidth=0, bg="green", fg="white")
    finishingBox.place(x=screen_width/2 - 28, y=screen_height/2 -160)
...
def gameWindow():
    ...
    rollButton =Button(gameWindow , text = 'Roll Dice' , fg = 'black' , bg = 'grey' , font = ("Chalkboard SE" , 15), width = 20 , height = 5 , command = rollDice )
...
def rollDice() :
    ...
    diceChoices = ['\u2680' , '\u2681' ,'\u2682', '\u2683' , '\u2684' , '\u2685']
    value = random.choices(diceChoices)
